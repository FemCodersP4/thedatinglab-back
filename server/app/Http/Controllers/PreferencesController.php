...
class PreferencesController extends Controller
{
    ...
    public function store(Request $request)
    {
        $validator = Validator::make($request->all(), [
            ...
            'values1' => ['required', 'max:1','in:honestidad,respeto,responsabilidad,empatia,integridad,gratitud,generosidad,tolerancia,solidaridad,humildad,perseverancia,justicia'],
            'values2' => ['required', 'max:1','in:honestidad,respeto,responsabilidad,empatia,integridad,gratitud,generosidad,tolerancia,solidaridad,humildad,perseverancia,justicia'],
            'values3' => ['required', 'max:1','in:honestidad,respeto,responsabilidad,empatia,integridad,gratitud,generosidad,tolerancia,solidaridad,humildad,perseverancia,justicia'],
